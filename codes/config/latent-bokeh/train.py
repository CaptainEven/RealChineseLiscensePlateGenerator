...
def main():
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            LQ, GT, alpha = train_data["LQ"], train_data["GT"], train_data["alpha"]
            src_lens, tgt_lens, disparity = train_data["src_lens"], train_data["tgt_lens"], train_data["disparity"]
            ...
            model.feed_data(states, latent_LQ, latent_GT, src_lens, tgt_lens, disparity=disparity, alpha=alpha) # xt, mu, x0
            ...
            if current_step % opt["train"]["val_freq"] == 0 and rank <= 0:
                ...
                for _, val_data in enumerate(val_loader):
                    ...
                    LQ, GT, alpha = val_data["LQ"], val_data["GT"], val_data["alpha"]
                    src_lens, tgt_lens, disparity = val_data["src_lens"], val_data["tgt_lens"], val_data["disparity"]
                    ...
                    # valid Predictor
                    model.feed_data(noisy_state, latent_LQ, GT, src_lens, tgt_lens, disparity=disparity)
            ...
            if error.value:
                sys.exit(0)
            #### save the_models and training states
            if current_step % opt["logger"]["save_checkpoint_freq"] == 0:
                if rank <= 0:
                    logger.info("Saving the_models and training states.")
