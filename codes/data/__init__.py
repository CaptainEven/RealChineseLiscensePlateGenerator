...
def create_dataset(dataset_opt):
    ...
    if mode == "LQ":  # Predictor
        ...
        from codes.data.StereoLQGT_dataset import StereoLQGTDataset as D
        dataset = D(dataset_opt)
    elif mode == 'SteLQ':
        from codes.data.StereoLQ_dataset import StereoLQDataset as D
        dataset = D(dataset_opt)
    elif mode == 'BokehLQGT':
        from codes.data.BokehLQGT_dataset import BokehLQGTDataset as D
        dataset = D(dataset_opt)
    elif mode == 'BokehLQ':
        from codes.data.BokehLQ_dataset import BokehLQDataset as D
        dataset = D(dataset_opt)
    else:
